...
CREATE TABLE `medical_center` (
    `pk_medical_center` BIGINT NOT NULL AUTO_INCREMENT,
...
-- AddForeignKey
ALTER TABLE `doctors` ADD CONSTRAINT `doctors_fk_medical_center_fkey` FOREIGN KEY (`fk_medical_center`) REFERENCES `medical_center`(`pk_medical_center`) ON DELETE RESTRICT ON UPDATE CASCADE;
